...
{
  private static final Logger s_aLogger = LoggerFactory.getLogger (JPALocalDateTimeConverter.class);

  public JPALocalDateTimeConverter ()
  {}
  ...
  public LocalDateTime convertDataValueToObjectValue (final Object aDataValue, final Session session)
  {
    if (aDataValue != null)
      try
      {
        return TypeConverter.convertIfNecessary (aDataValue, LocalDateTime.class);
      }
