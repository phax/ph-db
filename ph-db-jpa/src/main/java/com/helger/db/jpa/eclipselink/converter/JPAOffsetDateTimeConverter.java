...
public class JPAOffsetDateTimeConverter implements Converter
{
  ...
  @Nullable
  public OffsetDateTime convertDataValueToObjectValue (final Object aDataValue, final Session session)
  {
    if (aDataValue != null)
      try
      {
        return TypeConverter.convertIfNecessary (aDataValue, OffsetDateTime.class);
      }
